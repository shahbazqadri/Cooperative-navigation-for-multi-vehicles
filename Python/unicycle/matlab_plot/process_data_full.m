...
load no_control_ERR_full_150_1_test_NewNoise.mat%high_noise.mat
N = 20;
m = 5;
T = length(EST);
...
legend('basic guidance ','active guidance (obsv)',...
    'active guidance (SAM)', 'active guidance (inv cov)','location','best')
grid on
xlabel('time step (x 0.1 sec = time)')
ylabel('position RMSE (meters)')
