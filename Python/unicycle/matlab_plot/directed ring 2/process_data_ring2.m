...
load no_control_ERR_ring2_150_1_test_HighNoise_powell.mat
N = 20;
m = 5;
T = length(EST);
...
load control_ERR_ring2_150_1_test_HighNoise_powell_obsv.mat
N = 20;
m = 5;
T = length(EST);
...
load control_ERR_ring2_150_1_test_HighNoise_powell_SAM.mat
N = 20;
m = 5;
T = length(EST);
...
load control_ERR_ring2_150_1_test_HighNoise_powell_inv_cov.mat
...
load control_ERR_ring2_150_1_test_HighNoise_powell_det_inv_cov.mat
N = 20;
m = 5;
T = length(EST);
