...
% load no_control_ERR_full_150_1_test_NewNoise.mat
load no_control_ERR_full_150_1_test_HighNoise.mat
N = 20;
m = 5;
T = length(EST);
...
% load control_ERR_full_150_1_test_NewNoise_obsv.mat
load control_ERR_full_150_1_test_HighNoise_obsv.mat
N = 20;
m = 5;
T = length(EST);
...
% clear EST TRUTH;
% %load control_high_noise_full.mat%ERR_full_150.mat
% load control_ERR_full_150_1_test_NewNoise_min_eig_SAM.mat
% N = 20;
% m = 5;
% T = length(EST);
...
%%
clear EST TRUTH;
% load control_ERR_full_150_1_test_NewNoise_det_inv_cov.mat
load control_ERR_full_150_1_test_HighNoise_det_inv_cov.mat
N = 20;
m = 5;
T = length(EST);
